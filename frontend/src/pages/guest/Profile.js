...
function Profile() {
  ...
  const [data, loading] = useFetch(
    "http://localhost/guest/my?g_idx=" + idx.key
  );
  const [data1, loading1] = useFetch(
    "http://localhost/guest/reviewcount?g_idx=" + idx.key
  );
  const [data2, loading2] = useFetch(
    "http://localhost/guest/joindate?g_idx=" + idx.key
  );
  ...
  useEffect(() => {
    getReviewList("http://localhost/guest/review?g_idx=" + idx.key);
  }, []);
  ...
  useEffect(() => {
    getReplyList("http://localhost/guest/reply?g_idx=" + idx.key);
  }, []);
            ...
            <div className="col-5">
              <div className="container-lg">
                <div style={{ paddingLeft: "100px" }}>
                    ...
                    <div class="container text-center">
                      <div class="row">
                        <div class="col" style={{ lineHeight: "2.1" }}>
                          <span
                            dangerouslySetInnerHTML={{ __html: image_url }}
                          ></span>
                  ...
                  <div
                    className="card"
                    style={{ width: "23rem", height: "16rem", padding: "1rem" }}
                  >
                      ...
                      {modalOpen1 && (
                        ...
                        >
                          <div className={"modal-content3"}>
                            ...
                            <hr></hr>
                            <p>
                              '본인 인증' 절차를 거쳤거나 본인 인증 배지를
                              가지고 있다는 것은 sybnb 본인 인증 절차를 완료하기
                              위해 정보를 제공했다는 사실만을 의미합니다. 이
                              절차는 안전 장치를 갖추고 있지만, 누군가의 신원을
                              보장하지는 않습니다.{" "}
                            </p>
                          </div>
                        </div>

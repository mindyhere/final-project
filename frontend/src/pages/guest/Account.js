            ...
            <div>
                ...
                <div className={'btn-wrapper'}>
                    <div className={'modal-open-btn'} onClick={() => setModalOpen(true)}>
                        <div align='left' className='shadow p-1 mb-5 border border-success p-2 border-opacity-10 rounded' style={{width: '300px', height: '200px'}}>
                ...
                </div>
                {
                    ...
                    <div className={'modal-container'} ref={modalBackground} onClick={e => {
                      ...
                      <div className={'modal-content'}>
                        <h4>___님 프로필</h4>
                        <img src="/img/whitedog.jpg" width="210px" height="210px" style={{padding: "0.5rem"}}></img>
                        ...
                        <ul class="navbar-nav">
                            ...
                            <button className={'main-btn'}>수정</button></li>
                            <li style={{padding:'4px'}}>
                            <button className={'modal-close-btn'} onClick={() => setModalOpen(false)}>닫기</button></li>
                        </ul>
                      </div>
                    </div>
                }
                <div>
                    <div align='left' className='shadow p-1 mb-5 border border-success p-2 border-opacity-10 rounded' style={{width: '300px', height: '200px'}} onClick={() => navigate('/guest/Mypage')}>

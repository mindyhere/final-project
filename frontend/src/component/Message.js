...
function Message() {
    ...
    useEffect(() => {
            ...
            fetch('http://3.35.97.107/chatroom/list', {
                method: 'post',
                body: form,
            })
            .then(response => {
        ...
        return (
            ...
            <br/>
                ...
                {data.dto.map((item) => (
                    ...
                    <div style={{float: 'left', marginRight: '10px'}}><img src={gEmail==null ? (item.g_photo == 'http://3.35.97.107/images/guest/photo/-' ? '/img/no-image.png' : item.g_photo) : (item.h_profile == 'http://3.35.97.107/images/host/profile/-'? '/img/no-image.png' : item.h_profile) } width='30px' height='30px' /></div>
